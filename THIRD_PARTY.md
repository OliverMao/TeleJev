...
| LLM2Jev | https://github.com/Yinsongxu/LLM2Jev | — | Reference design for prefill-only scoring with shared-prefix staging. |
...
TeleJev is an independent project and is not affiliated with or endorsed by TypeSafe. It was formerly called OpenJev. Jev, TypeSafe, and other names and marks are the property of their respective owners. TeleJev code is provided under the repository's MIT License; third-party models and material retain their upstream terms.
